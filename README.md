# ⚡ ESP32 Perimeter Security Laser Tripwire & 24GHz Doppler Radar Node
...
High-security perimeter defense station combining modulated infrared laser tripwires, 24GHz FMCW Doppler radar speed/range gating, and PTZ camera pan-tilt tracking.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-perimeter-laser-doppler-radar.ino`](./esp32-perimeter-laser-doppler-radar.ino).
