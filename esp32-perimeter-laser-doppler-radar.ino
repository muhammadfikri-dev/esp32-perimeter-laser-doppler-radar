/**
 * =========================================================================================
 * Project     : ESP32 Perimeter Security Laser Tripwire & 24GHz Doppler Radar Node
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : High-security perimeter defense station combining modulated infrared laser tripwires, 24GHz FMCW Doppler radar speed/range gating, and PTZ camera pan-tilt tracking.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-perimeter-laser-doppler-radar";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Perimeter Security Laser Tripwire & 24GHz Doppler Radar Node"));
